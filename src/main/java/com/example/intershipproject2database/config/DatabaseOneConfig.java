package com.example.intershipproject2database.config;
...
public class DatabaseOneConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "com.example.intershipproject2database.repositories.dbone";
    public static final String ENTITY_PACKAGE = "com.example.intershipproject2database.entity.dbone";
