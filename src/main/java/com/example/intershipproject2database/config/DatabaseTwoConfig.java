...
public class DatabaseTwoConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "com.example.intershipproject2database.repositories.dbtwo";
    public static final String ENTITY_PACKAGE = "com.example.intershipproject2database.entity.dbtwo";
